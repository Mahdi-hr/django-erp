...
urlpatterns = [
    ...
    path('send/invoice/<int:invoice_pk>/', views.send_invoice_sms, name='send_invoice_sms'),
    ...
    path('messages/delete-by-date/', views.delete_messages_by_date, name='delete_messages_by_date'),
